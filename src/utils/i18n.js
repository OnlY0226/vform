...
import twLocaleElement from "element-ui/lib/locale/lang/zh-TW";
...
import twLocale_render from '@/lang/zh-TW_render';
import twLocale_extension from '@/lang/zh-TW_extension';
...
Vue.use(si18n, {
  lang: localStorage.getItem('v_form_locale') || 'zh-TW',
