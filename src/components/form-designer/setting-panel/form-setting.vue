    ...
    <el-form :model="formConfig" size="mini" label-position="left" label-width="120px"
      ...
      <el-collapse v-model="formActiveCollapseNames" class="setting-collapse">
        <el-collapse-item name="1" :title="i18nt('designer.setting.basicSetting')">
          ...
          <el-form-item :label="i18nt('designer.setting.saveRemoteOptions')">
            <el-radio-group v-model="formConfig.saveRemoteOptions" class="radio-group-custom">
              <el-radio-button label="never">{{i18nt('designer.setting.never')}}</el-radio-button>
              <!-- <el-radio-button label="ask">{{i18nt('designer.setting.ask')}}</el-radio-button> -->
              <el-radio-button label="always">{{i18nt('designer.setting.always')}}</el-radio-button>
            </el-radio-group>
          </el-form-item>
