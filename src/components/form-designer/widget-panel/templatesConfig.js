export const formTemplates = [
  {
    title: 'workflow基础表单',
    // /home/oy_ou/work/docpal-ui/
    // imgUrl: '@/components/form-designer/widget-panel/templates/templatesPhoto/workfolwBase.png',
    // jsonUrl: '/app/vformDesigner/src/components/form-designer/widget-panel/templates/workflowBase.json',
    // jsonDevPath: '@/components/widget-panel/templates/workflowBase.json',
    imgDevPath: './templates/templatesPhoto/workfolwBase.png',
    jsonDevPath: './templates/workflowBase.json',
    description: 'workflow基础表单'
  },
  {
    title: '单列表单',
