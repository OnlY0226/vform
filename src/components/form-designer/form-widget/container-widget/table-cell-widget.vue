        ...
        <template v-for="(subWidget, swIdx) in widget.widgetList">
          <template v-if="'container' === subWidget.category">
            <component :is="subWidget.type + '-widget'" :widget="subWidget" :designer="designer" :key="subWidget.id" :parent-list="widget.widgetList"
                              :index-of-parent-list="swIdx" :parent-widget="widget" @handlePreview="handlePreview"></component>
          </template>
          <template v-else>
            <component :is="subWidget.type + '-widget'" :field="subWidget" :designer="designer" :key="subWidget.id" :parent-list="widget.widgetList"
                          :index-of-parent-list="swIdx" :parent-widget="widget" :design-state="true" @handlePreview="handlePreview"></component>
          </template>
        </template>
      </transition-group>
    </draggable>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      handlePreview(file) {
        //console.log(file, 'table-cell-widget');
