          ...
          <template v-for="(widget, index) in designer.widgetList">
            <template v-if="'container' === widget.category">
              <component :is="getWidgetName(widget)" :widget="widget" :designer="designer" :key="widget.id" :parent-list="designer.widgetList"
                                :index-of-parent-list="index" :parent-widget="null" @handlePreview="handlePreview"></component>
            </template>
            <template v-else>
              <component :is="getWidgetName(widget)" :field="widget" :designer="designer" :key="widget.id" :parent-list="designer.widgetList"
                            :index-of-parent-list="index" :parent-widget="null" :design-state="true" @handlePreview="handlePreview"></component>
            </template>
          </template>
        </transition-group>
      </draggable>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      handlePreview(file) {
        //console.log(file, 'form-widget-form-designer');
